...
class TestTerminalExecutor:
    ...
    async def test_command_security_blocking(self):
        ...
        result = await self.executor.execute_command(
            "rm -rf /", require_confirmation=False
        )
    ...
    async def test_allowed_command_execution(self):
        ...
        with patch("asyncio.create_subprocess_shell") as mock_subprocess:
            ...
            result = await self.executor.execute_command(
                "ls -la", require_confirmation=False
            )
    ...
    async def test_command_timeout(self):
        ...
        with patch("asyncio.create_subprocess_shell") as mock_subprocess:
            ...
            result = await self.executor.execute_command(
                "echo test", timeout=1, require_confirmation=False
            )
    ...
    async def test_command_history(self):
        ...
        with patch("asyncio.create_subprocess_shell") as mock_subprocess:
            ...
            await self.executor.execute_command(
                "echo test1", require_confirmation=False
            )
            await self.executor.execute_command(
                "echo test2", require_confirmation=False
            )
    ...
    async def test_error_handling(self):
        ...
        with patch("asyncio.create_subprocess_shell") as mock_subprocess:
            ...
            result = await self.executor.execute_command(
                "echo test", require_confirmation=False
            )
    ...
    async def test_safety_level_configuration(self):
        ...
        with patch("asyncio.create_subprocess_shell") as mock_subprocess:
            ...
            result = await permissive_executor.execute_command(
                "unknown_command", require_confirmation=False
            )
    ...
    def test_history_limit(self):
        ...
        for i in range(5):
            result = CommandResult(
                command=f"test{i}", success=True, exit_code=0, execution_time=0.1
            )
