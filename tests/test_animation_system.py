...
from gerdsenai_cli.ui.animations import AnimationFrames, PlanCapture, StatusAnimation
...
"""
    ...
    print("✅ Plan extraction successful")
...
async def test_status_animation_mock():
    ...
    print("   - Start/stop functionality verified")
