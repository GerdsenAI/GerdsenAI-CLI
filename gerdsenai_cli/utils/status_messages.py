...
STATUS_MESSAGES = {
    OperationType.THINKING: [
        ...
        "Formulating strategic hypothesis",
        "Distilling conceptual essence",
        "Calibrating cognitive models",
        "Synthesizing mental frameworks",
        "Reasoning through possibilities",
        "Deliberating solution spaces",
        "Conceptualizing approaches",
        "Envisioning implementation pathways",
    ...
    OperationType.READING: [
        ...
        "Consuming source artifacts",
        "Interpreting symbolic expressions",
        "Scanning logical constructs",
        "Imbibing technical documentation",
        "Reviewing code narratives",
        "Traversing file hierarchies",
        "Processing textual corpus",
    ...
    OperationType.ANALYZING: [
        ...
        "Probing algorithmic complexity",
        "Dissecting design patterns",
        "Uncovering hidden dependencies",
        "Revealing architectural insights",
        "Detecting code anomalies",
        "Measuring cyclomatic paths",
        "Tracing execution flows",
        "Charting data transformations",
    ...
    OperationType.WRITING: [
        ...
        "Encoding elegant solutions",
        "Generating idiomatic patterns",
        "Transcribing mental models",
        "Inscribing best practices",
        "Documenting design decisions",
        "Producing modular components",
        "Creating reusable abstractions",
        "Authoring maintainable code",
    ...
    OperationType.PLANNING: [
        ...
        "Scheduling deliverable milestones",
        "Charting development timeline",
        "Coordinating parallel workstreams",
        "Allocating cognitive resources",
        "Optimizing task ordering",
...
CONTEXT_SUFFIXES = [
    ...
    "employing evidence-based approach",
    "with algorithmic methodology",
