...
class InputValidator:
    ...
    def validate_user_input(cls, user_input: str, max_length: int | None = None) -> str:
        ...
        # Normalize whitespace CAREFULLY - preserve newlines and indentation
        # Only limit excessive consecutive newlines; preserve spaces/tabs for code
        sanitized = re.sub(r"\n{3,}", "\n\n", user_input)  # Max 2 consecutive newlines
